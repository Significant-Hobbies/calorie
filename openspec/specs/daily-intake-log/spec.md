...
The system SHALL show recent foods with their default amount and SHALL make
rapid food logging the most prominent task on Today while retaining immediate
Undo.
